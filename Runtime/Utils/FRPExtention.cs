namespace UnityEngine.Rendering.Universal
{
    public static class FRPExtention
    {
        ...
        public static Matrix4x4 SetTRInverse(this Matrix4x4 mat, Vector3 pos, Quaternion q)
        {
            q.x = -q.x;
            q.y = -q.y;
            q.z = -q.z;
        ...
        public static Matrix4x4 SetBasisTransposed(this Matrix4x4 mat, Vector3 inX, Vector3 inY, Vector3 inZ)
        {
            ...
            mat[0, 2] = inX[2]; mat[1, 2] = inY[2]; mat[3, 2] = inZ[2]; mat[3, 2] = 0;
            mat[0, 3] = 0;      mat[1, 3] = 0;      mat[2, 3] = 0;      mat[3, 3] = 1;
            return mat;
        }
        
        public static Matrix4x4 SetTranslate(this Matrix4x4 mat, Vector3 inTrans)
        {
