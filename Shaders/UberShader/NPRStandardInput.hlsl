...
#include "Packages/com.fern.renderpipeline/ShaderLibrary/SurfaceDataNPR.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/CommonMaterial.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/SurfaceInput.hlsl"
#include "Packages/com.unity.render-pipelines.core/ShaderLibrary/ParallaxMapping.hlsl"
#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/DBuffer.hlsl"
#include "Packages/com.fern.renderpipeline/ShaderLibrary/FernShaderUtils.hlsl"

#if _NPR
    #include "Packages/com.fern.renderpipeline/ShaderLibrary/NPRInput.hlsl"
#elif _MIRCOGARIN
    #include "Packages/com.fern.renderpipeline/ShaderLibrary/NPRInput.hlsl"
#endif
...
#if _MIRCOGARIN
    TEXTURE2D(_PorousMap);				SAMPLER(sampler_PorousMap);
#endif
...
inline half SpecularAA(half3 normalWS, half smoothness)
{
    ...
    half roughnessAA = roughness * roughness + min(_SpaceScreenThresold * (dx + dy) * 8, _SpecularAAStrength * _SpecularAAStrength);
...
inline void InitializeNPRStandardSurfaceData(float2 uv, InputData inputData, out SurfaceData outSurfaceData)
{
    ...
    #if _SPECULARMASK
        outSurfaceData.specularIntensity = GetVauleFromChannel(pbrLightMap, shadingMap01, _SpecularIntensityChannel) * _SpecularIntensity;
    #else
    ...
    #if _MIRCOGARIN
        outSurfaceData.porousColor = SAMPLE_TEXTURE2D(_PorousMap,sampler_PorousMap, uv.xy * _PorousMap_ST.xy + _PorousMap_ST.zw).rgb * _PorousColor.rgb;
        outSurfaceData.porousDensity = GetVauleFromChannel(pbrLightMap, shadingMap01, _PorousDensityChannel) * _PorousDensity;
        outSurfaceData.porousSmoothness = _PorousSmoothness;
        outSurfaceData.porousMetallic = _PorousMetallic;
    #endif
